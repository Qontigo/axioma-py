#!/usr/bin/env pwsh
#
# NOTE: This file is maintained in the Qontigo/devops-gh-actions repo (scripts/common/core-convert.psm1) and that copy will overwrite any changes made in any repo using the file
